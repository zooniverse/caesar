      ...
      context 'when effect adds subjects to set' do
        ...
        context 'when user does not have permission to that set' do
          ...
          it 'flashes an error message' do
            post :create, params: create_params, format: :html
            msg = 'You do not have permission to create this subject rule effect. Please check project collaborator status and subject set or collection IDs.'
    ...
    describe '#update' do
      ...
      context 'when effect adds subjects to subject set' do
        ...
        context 'when user does not have permission to that set' do
          ...
          it 'flashes an error message' do
            put :update, params: subject_set_update_params, format: :html
            msg = 'You do not have permission to update this subject rule effect. Please check project collaborator status and subject set or collection IDs.'
            expect(flash[:alert]).to eq(msg)
          end
        end
