...
RSpec.describe UserRulesController, type: :controller do
  ...
  describe '#create' do
    it 'makes a new rule' do
      ...
      post :create, params: {user_rule: {condition: condition.to_json}, workflow_id: workflow.id}, format: :json
  ...
  describe '#update' do
    it 'changes a rule' do
      ...
      put :update, params: {user_rule: {condition: condition2.to_json}, workflow_id: workflow.id, id: rule.id}, format: :json
