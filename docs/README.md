...
Welcome to the new Caesar API documentation site.
...
1. `cd docs` Ensure you are in the docs directory (current path for this README)
...
Once deployed these docs are available at https://zooniverse.github.io/caesar
